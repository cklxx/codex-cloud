...
| `config`                | object  | Individual [config settings](https://github.com/cklxx/codex-cloud/blob/main/docs/config.md#config) that will override what is in `$CODEX_HOME/config.toml`. |
